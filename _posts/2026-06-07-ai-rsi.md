...
There is a structural reason to expect decay. Capability gain consumes two inputs: cognitive labor, that is, deciding what to try, writing the code, and interpreting results, and research compute, that is, the hardware experiments run on.
